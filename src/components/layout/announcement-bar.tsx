...
export function AnnouncementBar() {
  ...
  return (
    <div className="flex h-12 items-center border-b border-[#F2D7D7] bg-[#FFF3F3]">
      <div className="mx-auto flex w-full max-w-[1200px] flex-wrap items-center justify-center gap-x-3 gap-y-1 px-6 text-center lg:px-8">
